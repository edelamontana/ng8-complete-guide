...
export class RecipeEditComponent implements OnInit {
	...
	private initForm() {
		...
		this.recipeForm = new FormGroup({
			...
			_imagePath: new FormControl(recipeImagePath, Validators.required),
	...
	// Evita el error Identifier 'controls' is not defined. 'AbstractControl' does not contain such a member
	// en el HTML
	getControls() {
